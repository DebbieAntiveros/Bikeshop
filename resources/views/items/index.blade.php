...
<div class="d-flex justify-content-center">
	<label style="margin-top: 0px; font-size:45px;"> Product </label>
</div>
<div class="content" style="margin: 0px;">
	...
	<div class="container" style="margin-top: 15px;">
		<table class="table table-bordered" id="data-table">
			...
			<tbody> @foreach($items as $item) @if($item -> quantity_left>0)
				<tr>
			...
			<form> @csrf
				<div class="modal-body">
					<div class="form-group">
						...
						<select name="s_product" class="form-control"> @foreach($items as $item)
							<option cllass="form-control" value={{$item -> item_code}}>{{$item -> item_name}}</option> @endforeach </select>
					</div>
					<div class="form-group">
