...
@section('content')
<div class="d-flex justify-content-center"> <label style="margin-top: 0px; font-size:45px;"> Inventory </label> </div>
        <div class="content" style="margin: 0px;">
            ...
            <div class="container">
                ...
                <tr>
                    ...
                    <td> {{ $inventory -> quantity_left * $inventory -> selling_price }}</td> 
                    <td> 
